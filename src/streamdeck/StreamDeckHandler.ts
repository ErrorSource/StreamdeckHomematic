...
import { Switch1Handler } from "./Handler/Switch1/Switch1Handler";
import { Switch2Handler } from "./Handler/Switch2/Switch2Handler";
...
export class StreamDeckHandler {
    ...
    constructor(streamdeck: StreamDeck) {
        ...
        this.messageHandlers.push(new Switch1Handler());
        this.messageHandlers.push(new Switch2Handler());
